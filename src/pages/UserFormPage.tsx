...
import { SURVEY_QUESTIONS, LIKERT_OPTIONS, SEDES_UNAD, getFeedbackForScore, Feedback } from '../constants';
...
type FormAction =
  ...
  | { type: 'SET_SCORE'; payload: { questionId: string; value: number } };
...
const UserFormPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSubmissionResult({ submission: { ...submission, id: ''}, feedback: feedbackData });
    } catch (err) {
