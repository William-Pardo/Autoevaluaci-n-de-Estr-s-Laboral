...
import { Submission, StressLevel } from '../types';

interface ResultsTableProps {
    submissions: Submission[];
}

const ResultsTable: React.FC<ResultsTableProps> = ({ submissions }) => {
  ...
  const getStressLevelColor = (level: StressLevel) => {
    switch(level) {
        case StressLevel.Bajo: return 'bg-green-100 text-green-800';
        case StressLevel.Moderado: return 'bg-yellow-100 text-yellow-800';
        case StressLevel.Alto: return 'bg-red-100 text-red-800';
